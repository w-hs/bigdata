...
TODO: Marvin und Jogi
- Link zum Git-Repository
- Allgemeiner Aufbau
- Ordnerstruktur
- code
- - Iterationen (Code spezifisch für eine Iteration)
- - AWS (Hive-Skripte für AWS)
- - triskellion (Umsetzung von dem Kaggle-Nutzer http://mlwave.com/predicting-repeat-buyers-vowpal-wabbit/)
- doku
- grafiken
- submissions
