...
Im Nachfolgenden werden alle Iterationen der Reihe nach vorgestellt. \todo{evtl github link als nachweis der ergebnisse aufnehmen}
...
\end{lstlisting}
\todo{evtl. eigenes Highlighting entwerfen}
